---
title: "Incidence, Risk Factors for and Outcomes of Transplant-Associated Thrombotic Microangiopathy"
...
```{r}
# Remove column 27 and drop any rows with NAs
working_df <- data[,-27]
...
```
# 10. Visualization of Key Relationships
...
```
# 11. Assessing Feature Correlations & Variable Effects
